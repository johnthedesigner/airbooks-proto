...
import { spreadLaneData } from "@/utils/spreadUtilsAlt";
...
const SpreadByMaturity = ({
  ...
  const getSpreadRange = (maturity: any) => {
    ...
    } else if (simpleSpread < 1) {
      return "a";
    } else if (simpleSpread < 2) {
      return "b";
    } else if (simpleSpread < 3) {
      return "c";
    } else if (simpleSpread < 5) {
      return "d";
    } else if (simpleSpread < 10) {
      return "e";
    } else if (simpleSpread < 20) {
      return "f";
    } else if (simpleSpread < 30) {
      return "g";
    } else if (simpleSpread < 50) {
      return "h";
    } else if (simpleSpread < 75) {
      return "i";
    } else if (simpleSpread < 100) {
      return "j";
    } else if (simpleSpread < 150) {
      ("k");
    } else {
      ("l");
    }
            ...
            <Scatter
              ...
              {filteredParByMaturity.map((entry: any, index: number) => {
                let colors: Record<string, any> = {
                  a: palettes.blue[3],
                  b: palettes.blue[6],
                  c: palettes.turquoise[3],
                  d: palettes.turquoise[6],
                  e: palettes.green[3],
                  f: palettes.green[6],
                  g: palettes.yellow[3],
                  h: palettes.yellow[6],
